...
export async function POST(req: Request) {
  ...
  let prompt = [
    ...
    3. If you find relevant legislation in the context:
       ...
       - Cite the legislation by mentioning both the "cap_number" and "title" (e.g., "According to CAP 347 - Section 27 'Time limit for personal injuries', ...").
    ...
    4. If none of the provided legislation is directly relevant to the user's question, or if the context alone is insufficient to provide a complete answer:
       ...
       - Clearly state that your answer is based on your general knowledge and not on the specific legislation provided in the context.
